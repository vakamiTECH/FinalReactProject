...
function HomePage() {
  return (
    <div className="relative flex justify-center items-center max-w-1200px mx-auto px-4 sm:px-6 lg:px-8">
      <img
        src={backgroundImage}
      ...
      <div className="w-2/4 absolute flex top-2 left-36">
        <p className="text-primary font-big-shoulders-display text-xl font-bold tracking-wide leading-normal m-5">
          ...
          project, whether you are into retro cars, race cars, rusted one,
          crashed cars and even motorcycles. Most important is it should{' '}
